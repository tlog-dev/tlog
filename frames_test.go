...
func testStackTraceInside() (st Frames) {
	func() {
		func() {
			st = Callers(1, 3)
		}()
...
func TestLocationStackTraceString(t *testing.T) {
	...
	re := `tlog.testStackTraceInside.func1                               at [\w.-/]*frames_test.go:24
tlog.testStackTraceInside                                     at [\w.-/]*frames_test.go:25
tlog.TestLocationStackTraceString.func1.1                     at [\w.-/]*frames_test.go:33
`
