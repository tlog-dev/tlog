...
It's fast. I mean I've made number of improvements that gave another [50ns gain](https://pkg.go.dev/github.com/nikandfor/tlog#AppendPrintf) after all the usual methods had been defeated.
...
`net/trace`, Google Trace API, maybe jaeger backend...
